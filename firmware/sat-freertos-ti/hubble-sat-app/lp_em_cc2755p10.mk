...
# The Hubble Device SDK is not vendored here. It is checked out beside this app
# at the revision named in ../sdk-revision, the same way the Zephyr satellite
# workspace pins it in west.yml.
HUBBLE_NETWORK_SDK ?= $(abspath ../hubble-device-sdk)
NAME = hubble-sat-app
...
SYSCFG_FILES := $(shell $(SYSCFG_CMD_STUB) --listGeneratedFiles --listReferencedFiles --output $(BUILD_DIR) hubble-sat-app.syscfg)
...
syscfg: hubble-sat-app.syscfg $(BUILD_DIR)
...
syscfg-gui: hubble-sat-app.syscfg $(SYSCONFIG_GUI_TOOL)
